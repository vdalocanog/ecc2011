...
public class OrgServiceMockTest {
 ...
 public void testExample() {
  ...
  System.out.println("SUCCESS: addOrg(Org object)");
  ...
  System.out.println("SUCCESS: updateOrg(Org object)");
  ...
  //assert
  Assert.assertTrue(orgService.deleteOrg(1));
  System.out.println("SUCCESS: deleteOrg(long id)");
  ...
  System.out.println("SUCCESS: findAllOrg()");
  ...
  System.out.println("SUCCESS: findOrg(String column, String value)");
  ...
  System.out.println("SUCCESS: findOrgs(String column, String value)");
